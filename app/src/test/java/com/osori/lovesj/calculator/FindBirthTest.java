...
public class FindBirthTest {

    @Test
    public void 올해_지난_날짜_양력() {
        LocalDate nextBirthDay = BirthDayCalculator.findNextBirthDay(LocalDate.of(1990, 6, 23), false);
    ...
    public void 올해_안지난_날짜_양력() {
        LocalDate nextBirthDay = BirthDayCalculator.findNextBirthDay(LocalDate.of(1993, 9, 23), false);
    ...
    public void 올해_지난_날짜_음력() {
        LocalDate nextBirthDay = BirthDayCalculator.findNextBirthDay(LocalDate.of(1961, 7, 14), true);
    ...
    public void 올해_안지난_날짜_음력() {
        LocalDate nextBirthDay = BirthDayCalculator.findNextBirthDay(LocalDate.of(1975, 9, 14), true);
